...
export default tool({
  ...
  instructions:
    'Updates one or more fields of a writ. Title and body can be edited regardless of phase. ' +
    'Type and codex can only be changed while the writ is in "new" (draft) phase. ' +
