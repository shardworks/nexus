...
mandate writ posted
  ...
  │     → walks plan.observations; creates one draft `mandate` child writ per
  │       record under the originating mandate (parentId, draft: true), with
